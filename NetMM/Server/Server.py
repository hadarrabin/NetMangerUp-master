...
class server():
    ...
    def connectdb(self):
        ...
        conn = pypyodbc.connect(
            ...
            r"Dbq=C:\Users\Hadar\Documents\NetMangerUp-master\WindowsFormsApplication3\WindowsFormsApplication3\Database21.accdb;")
        cur = conn.cursor()
        return cur
...
class CommunicationS():
    def __init__(self,client_socket,GUI_pipe):
   """
time.sleep(1)
ser = server()
ser.start()